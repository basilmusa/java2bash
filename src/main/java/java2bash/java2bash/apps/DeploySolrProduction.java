...
public class DeploySolrProduction 
{
    public static void main( String[] args )
    {
    	...
    	bashScript.add(new Description("The following step will checkout the latest master branch and merge it here by running the following commands:\n"
    			+ "\tgit checkout master\n"
    			+ "\tgit fetch origin\n"
    			+ "\tgit merge origin/master\n"
    			+ "", EnumSet.of(TextStyle.CYAN)));
    	...
    	bashScript.add(new Description("Please confirm that the MySQL Database URL provided in the configuration file:\n\n"
    	...
    	bashScript.add(new Description("Will restart Solr service by issuing the following command:\n\n"
    	...
    	// 
    	bashScript.add(new Description("Deployment has been performed successfully. Please wait 5 to 10 minutes for Solr indexes to fully re-index.",
    			TextStyle.GREEN));
